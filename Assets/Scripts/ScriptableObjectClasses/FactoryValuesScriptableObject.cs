...
public class FactoryValuesScriptableObject : DescriptionBaseSO
{
    ...
    [field:SerializeField] public BigDouble TimeBetweenPayouts { get; private set; } // in milliseconds
    ...
    [field: SerializeField] public BigDoubleVariable PayoutAmountSO { get; private set; }
    [field: SerializeField] public BigDoubleVariable UpgradeCostSO { get; private set; }
    [field: SerializeField] public BigDoubleVariable PayoutTimeRemainingSO { get; private set; } // in milliseconds
